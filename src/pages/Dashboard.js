...
import { FaCalendarAlt, FaFileAlt, FaEnvelope, FaUserAlt, FaBirthdayCake, FaFileInvoiceDollar, FaRobot, FaFileContract, FaBoxOpen, FaWarehouse, FaBrain, FaCommentDots, FaMoneyBillWave, FaChartLine, FaChartBar, FaRupeeSign, FaShieldAlt, FaFilePdf, FaUserTie, FaSearch } from 'react-icons/fa';
...
const workflowData = [
  {
    title: 'Automated Research AI Agent',
    icon: FaSearch,
    path: '/automated-research',
    summary: 'Input any topic and receive a comprehensive research report as a downloadable PDF.'
  },
  {
  ...
  //   icon: FaChartLine,
  //   path: '/performance-review-summary',
  //   summary: 'Summarize employee performance reviews, strengths, and improvement areas with AI-powered insights.'
  // },
  {
    title: 'Interview Panel Auto-Assignment',
    icon: FaUserTie,
    path: '/interview-panel-assignment',
    summary: 'Automatically assign interviewers to candidates and notify the panel.'
  }
];

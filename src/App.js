...
import SalesForecastAIPredictivePlanningPage from './pages/SalesForecastAIPredictivePlanningPage';
import './App.css';
import './index.css';
        ...
        <div className="min-h-screen bg-gradient-to-br from-background via-background-secondary to-background-tertiary">
          <main className="flex-1 flex flex-col items-center justify-center p-4">
            <Routes>
              ...
              <Route path="/workflows/sales-forecast-ai" element={<SalesForecastAIPredictivePlanningPage />} />
            </Routes>
          </main>
        </div>
      </ErrorBoundary>
